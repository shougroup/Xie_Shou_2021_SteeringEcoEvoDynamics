...
MfracDiff_adjusted1 = MfracT  - ones(ysize, 1) * (y0 : dy : yt);
MfracDiff_adjusted2 = MfracT * (1-spike_frac) - ones(ysize, 1) * (y0 : dy : yt);
figure(2)
contour((x0:dx:xt), (y0:dy:yt), P',  (min(P(:)) : 500 : max(P(:))), 'linewidth', 3); % , (min(P(:)) : 240 : max(P(:)))
