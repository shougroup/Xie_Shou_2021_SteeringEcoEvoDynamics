...
hold on
for i = 1:r_num
    plot((1:length(B0{i})) ,B0{i}, 'color', cl{i}, 'Linewidth', 1);
end
plot([1 C], [1000/3 1000/3], 'g--', 'Linewidth', 1.5)
hold off
axis([1 C 0 350])
xticks((1e3:1e3:C))
set(gca,'box','on','LineWidth',2,'FontSize',16,'FontName','Arial','fontweight','bold','units','inches','position',[1 1 3 3],'ticklength',[0.04 0.04])%,'xticklabel',[])
xlabel('Cycles','FontSize',16,'FontName','Arial','fontweight','bold');
ylabel('B0','FontSize',16,'FontName','Arial','fontweight','bold');
