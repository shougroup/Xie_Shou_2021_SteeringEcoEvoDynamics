...
J11 = -sum(c_BM*gM_maxM_L.*dM_coefdB) + sum(gH_maxH_L.*dH_coefdB);
J12 = -sum(c_BM*gM_maxM_L.*dM_coefdR) + sum(gH_maxH_L.*dH_coefdR);
J21 = -sum(c_RM*gM_maxM_L.*dM_coefdB) - sum(c_RH*gH_maxH_L.*dH_coefdB);
