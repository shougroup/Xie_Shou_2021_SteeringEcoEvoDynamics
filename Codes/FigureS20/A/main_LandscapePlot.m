...
% figure(1)
% contour3((x0:dx:xt), (y0:dy:yt), P', (min(P(:)) : 20 : max(P(:))),'linewidth',3)
% % contour3((x0:dx:xt), (y0:dy:yt), P', 'linewidth',3)
% cm = colormap('gray');
% c = 1-cm;
% colormap(c)
% ylim([0.01 0.99])
...
figure(2)
contour((x0:dx:xt), (y0:dy:yt), P', (min(P(:)) : 20 :  max(P(:))), 'linewidth', 3);
% contour((x0:dx:xt), (y0:dy:yt), P', 'linewidth', 3);
