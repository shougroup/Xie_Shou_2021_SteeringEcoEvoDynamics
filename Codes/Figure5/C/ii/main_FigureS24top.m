...
for i =1:100
    load(['HeriData2/adults' num2str(i)]) % simulation results for Adults offspring from the ith parent
...
hold on
plot([300 1000], [300 1000]*pfit(1)+pfit(2), '--', 'color', [0 0.5 0], 'linewidth', 2)
hold off
